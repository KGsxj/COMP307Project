...
Ruihan Zhang  |261164830       |We built the backend entirely from scratch using Express.js          | Built the full study-session backend feature from model to routes.
                               ...
                               |syntax verification rather than code generation.                     | Implemented APIs to create, update, delete, view, join, and leave sessions.
                                                                                                     ...
                                                                                                     | Moreoever, I was also responsible for the UI design, where I focused on making the platform clean, intuitive, 
                                                                                                     | and easy for students to use. I designed the interface so users can quickly view sessions, understand key details 
                                                                                                     | (course, time, location, organizer), and complete actions like joining or leaving with minimal steps. My goal was
                                                                                                     | to keep the layout simple and consistent across pages while improving usability, readability, and overall user 
                                                                                                     | experience. (The detail is in the report)
